...
import 'cadence_measure_slow_viewmodel.dart';

class CadenceMeasureSlowView extends StackedView<CadenceMeasureSlowViewModel> {
  const CadenceMeasureSlowView({Key? key}) : super(key: key);

  @override
  void onDispose(CadenceMeasureSlowViewModel viewModel) {
    viewModel.stopSound();
  ...
  Widget builder(
    ...
    CadenceMeasureSlowViewModel viewModel,
    Widget? child,
  ) {
    return Column(
        ...
        AnimatedSize(
          ...
          child: viewModel.detectedStep == 5
              ? const Padding(
                  ...
                  child: Text(
                    'When you are ready, instruct patient to walk as quickly as they can, comfortably. Once they have reached a steady speed, press "Next"',
  ...
  @override
  CadenceMeasureSlowViewModel viewModelBuilder(
    BuildContext context,
  ) =>
      CadenceMeasureSlowViewModel();
}

...
import 'package:scioto_mobile/ui/views/survey_3/survey_3_viewmodel.dart';
import 'package:stacked/stacked.dart';
import 'package:syncfusion_flutter_sliders/sliders.dart';

class Survey3View extends StackedView<Survey3ViewModel> {
  const Survey3View({Key? key}) : super(key: key);

  @override
  Widget builder(
    BuildContext context,
    Survey3ViewModel viewModel,
    Widget? child,
  ) {
    return Column(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const Expanded(
                      child: Text(
                    'Over the past four weeks, rate the weight of your prosthesis.',
  ...
  @override
  Survey3ViewModel viewModelBuilder(
    BuildContext context,
  ) =>
      Survey3ViewModel();
}

...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<ControlsService>(onMissingStub: OnMissingStub.returnDefault),
...
MockControlsService getAndRegisterControlsService() {
  _removeRegistrationIfExists<ControlsService>();
  final service = MockControlsService();
  locator.registerSingleton<ControlsService>(service);
  return service;
}
